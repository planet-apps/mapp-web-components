<svelte:options customElement="apint-menu" />

<script lang="ts">
  import { fade, slide, fly, blur, scale } from 'svelte/transition';
  import ApintHeaderLite from "./MappHeaderLite.svelte";
...
<div class="outer_frame">
  ...
  <div class="right_panel">
    <ApintHeaderLite supportuser={supportuser} username={username} userpic={userpic}></ApintHeaderLite>
